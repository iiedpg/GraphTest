...
public class ReduceTask extends Task {
  ...
  public void run(JobConf job, final TaskUmbilicalProtocol umbilical)
    ...
    if (!isLocal) {
      ...
      Record shuffleRecord = TimeRecorder.getRecord("shuffle_all");
      shuffleRecord.timerStart();
      rIter = shuffleConsumerPlugin.run();
      shuffleRecord.timerEnd();
    } else {
  ...
  static class NewTrackingRecordWriter<K,V> 
    ...
    private Record outputRecord = TimeRecorder.getRecord("output_kvs");
    private Record outputBytesRecord = TimeRecorder.getRecord("output_bytes");
    private Record outputTimes = TimeRecorder.getRecord("output_time");
    ...
    NewTrackingRecordWriter(ReduceTask reduce,
      ...
      outputBytesRecord.increValue(bytesOutCurr - bytesOutPrev);
    }
    ...
    public void write(K key, V value) throws IOException, InterruptedException {
      ...
      outputRecord.increValue(1);
      outputTimes.timerEnd();
    }
