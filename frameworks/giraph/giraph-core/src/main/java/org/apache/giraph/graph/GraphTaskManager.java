...
import com.apache.giraph.gaoyun.TimeRecorder2;
import com.apache.giraph.gaoyun.TimeRecorder2.Record2;
...
public class GraphTaskManager<I extends WritableComparable, V extends Writable,
  ...
  Record2 computeRecord = TimeRecorder2.getRecord("compute");
  
  public static Record2 sendMessageRecord = TimeRecorder2.getRecord("send_message");
  public static Record2 waitMsgRecord = TimeRecorder2.getRecord("waitMsg");
  public static Record2 waitOthersRecord = TimeRecorder2.getRecord("waitOthers");
  

  public static Record2 getIteratorRecord = TimeRecorder2.getRecord("getIterator");
  public static Record2 iterAllRecord = TimeRecorder2.getRecord("iterAll");
  public static Record2 computerAllRecord = TimeRecorder2.getRecord("computerAll");
  
  public static long messageSendBytes;
  //public static Record SendMessageSizeRecord = TimeRecorder.getRecord("send_mess_size");
  ...
  */
  public void execute() throws IOException, InterruptedException {
    ...
    Record2 loadVertexesRecord = TimeRecorder2.getRecord("load_vertexes");
    
    loadVertexesRecord.timerStart();
    finishedSuperstepStats = serviceWorker.setup();
    loadVertexesRecord.timerEnd();
    ...
    do {
      ...
      sendMessageRecord.multiTimerStart();      
      messageSendBytes = 0;
      
      getIteratorRecord.multiTimerStart();
      iterAllRecord.multiTimerStart();
      computerAllRecord.multiTimerStart();
      ...
      if (numPartitions > 0) {
    	TimeRecorder2.addMemoryRecord("before_handle_" + superstep);
        processGraphPartitions(context, partitionStatsList, graphState,
          messageStore, numPartitions, numThreads);
        TimeRecorder2.addMemoryRecord("after_handle_" + superstep);
      }
      ...
      sendMessageRecord.multiTimerEnd();
      LOG.info("message sent = " + messageSendBytes + ", superstep = " + superstep);
      //GraphTaskManager.SendMessageSizeRecord.addNewValue(messageSendBytes);
      getIteratorRecord.multiTimerEnd();
      iterAllRecord.multiTimerEnd();
      computerAllRecord.multiTimerEnd();
      
      TimeRecorder2.addMemoryRecord("turn_end_" + superstep);
 ...
 /**
  ...
  private static GraphFunctions determineGraphFunctions(
	...
	LOG.info("split master worker = " + splitMasterWorker);
  ...
  private void initializeAndConfigureLogging() {
    ...
    if (conf.useLogThreadLayout()) {
      PatternLayout layout =
        new PatternLayout("%-7p %d [%t] %c:%L - %m%n");
  ...
  private void processGraphPartitions(final Mapper<?, ?, ?, ?>.Context context,
    ...
    computeRecord.multiTimerStart();   
    computeRecord.multiContinue();
    ...
    computeRecord.multiPause();
    computeRecord.multiTimerEnd();
