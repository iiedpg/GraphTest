...
std::vector<ThreadContext*>& get_all_thread_contexts(){
	static std::vector<ThreadContext*> all_contexts;
	return all_contexts;
}

pthread_mutex_t* get_thread_contexts_lock(){
	static pthread_mutex_t lock = PTHREAD_MUTEX_INITIALIZER;
	return &lock;
}

void delete_thread_context(void* obj){
...
ThreadContext& get_my_thread_context(){	
