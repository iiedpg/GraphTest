...
public class DirectAddWeight {

	public static class DirectAddWeightMapper extends
		...
		protected void map(
			...
			context.write(new IntWritable(vid), new Text(vid + "\t"
					+ 0));
		}
	}
	...
	public static void main(String[] args) {
		try {
			...
			job.setJarByClass(DirectAddWeight.class);
			job.setMapperClass(DirectAddWeightMapper.class);
			...
			thisTurnJob.setJarByClass(DirectAddWeight.class);
