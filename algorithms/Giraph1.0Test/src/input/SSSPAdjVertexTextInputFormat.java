...
public class SSSPAdjVertexTextInputFormat extends
		TextVertexInputFormat<IntWritable, SSSPVertexValue, DoubleWritable> {

	@Override
	public org.apache.giraph.io.formats.TextVertexInputFormat.TextVertexReader createVertexReader(
			InputSplit split, TaskAttemptContext context) throws IOException {
		return new SSSPAdjVertexReader();
	}

	public class SSSPAdjVertexReader extends
		...
		@Override
		protected SSSPVertexValue getValue(String[] arg0) throws IOException {
