 ...
 **************************************************************************/
  ...
  private: 
    ...
    void eval_sched_task(const lvid_type lvid,
	  ...
	  long acquire_lock_end = get_time_us();
	  tc.total_lock += (acquire_lock_end - start);
	 ...
	 long eval_end = get_time_us();
	 tc.total_eval += (eval_end - start);
	 tc.eval_times += 1;
	 tc.last = eval_end;
 ...
 **************************************************************************/
  ...
  public:
    ...
    execution_status::status_enum start() {
	  ...
	  get_gaoyun_out() << "ncpus = " << ncpus << ",nfibers = " << nfibers << "\n";
