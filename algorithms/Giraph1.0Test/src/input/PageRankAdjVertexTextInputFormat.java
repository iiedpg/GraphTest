...
public class PageRankAdjVertexTextInputFormat extends
	...
	public org.apache.giraph.io.formats.TextVertexInputFormat.TextVertexReader createVertexReader(
		...
		return new PageRankAdjVertexReader();
	}

	public class PageRankAdjVertexReader extends
		...
		@Override
		protected DoubleWritable getValue(String[] arg0) throws IOException {
