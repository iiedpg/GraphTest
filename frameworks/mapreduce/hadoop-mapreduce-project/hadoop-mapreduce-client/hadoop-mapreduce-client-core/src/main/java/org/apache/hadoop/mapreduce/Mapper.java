...
public class Mapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {
  ...
  public void run(Context context) throws IOException, InterruptedException {
    setup(context);
    try {
      Record timeRecord = TimeRecorder.getRecord("input");
      Record mapTimeRecord = TimeRecorder.getRecord("f");
      
      timeRecord.timerStart();
      boolean hasMore = context.nextKeyValue();
      timeRecord.timerEnd();
      
      int i = 0;
      while (hasMore) {
    	mapTimeRecord.timerStart();   	  
        map(context.getCurrentKey(), context.getCurrentValue(), context);
        mapTimeRecord.timerEnd();
